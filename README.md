# poker44-miner-gen10heur7

Minimal release repository for model gen10heur7.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur7.git
cd poker44-miner-gen10heur7
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur7`.
